...
using UtilZ.Lib.Winform.PartAsynWait.Excute.Winform;
...
namespace UtilZ.Lib.Winform.PartAsynWait
{
    ...
    public class PartAsynExcuteFactoryWinform : PartAsynExcuteFactoryBase
    {
        ...
        public override IAsynExcute<T, TContainer, TResult> CreateExcute<T, TContainer, TResult>()
        {
            ...
            {
                asynExcute = new UtilZ.Lib.Winform.PartAsynWait.Excute.Winform.V1.WinformPartAsynExcuteV1<T, TContainer, TResult>();
            }
            else if (type == WinformPartAsynExcuteTypeDefine.OpacityDisableTab)
            {
                asynExcute = new UtilZ.Lib.Winform.PartAsynWait.Excute.Winform.V2.WinformPartAsynExcute2<T, TContainer, TResult>();
            }
            else if (type == WinformPartAsynExcuteTypeDefine.OpacityShadeDisableTab)
            {
                asynExcute = new UtilZ.Lib.Winform.PartAsynWait.Excute.Winform.V3.WinformPartAsynExcute3<T, TContainer, TResult>();
            }
            else if (type == WinformPartAsynExcuteTypeDefine.ScreenshotImgBackgrounDisableTab)
            {
                asynExcute = new UtilZ.Lib.Winform.PartAsynWait.Excute.Winform.V4.WinformPartAsynExcute4<T, TContainer, TResult>();
            }
            else if (type == WinformPartAsynExcuteTypeDefine.OpacityCustomerDisableTab)
            {
                asynExcute = new UtilZ.Lib.Winform.PartAsynWait.Excute.Winform.V5.WinformPartAsynExcute5<T, TContainer, TResult>();
            }
            else
            {
