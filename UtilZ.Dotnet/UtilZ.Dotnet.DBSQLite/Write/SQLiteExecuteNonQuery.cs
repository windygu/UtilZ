...
namespace UtilZ.Dotnet.DBSQLite.Write
{
    ...
    public class SQLiteExecuteNonQuery : SQLiteWriteBase
    {
        ...
        public SQLiteExecuteNonQuery(int waitTimeout, string sqlStr, NDbParameterCollection collection) : base(waitTimeout, 1)
        {
            this._sqlStr = sqlStr;
        ...
        public override object Excute(ISQLiteDBAccessBase sqliteDBAccess)
        {
            ...
            {
                case 1:
                    this.Result = sqliteDBAccess.BaseExecuteNonQuery(this._sqlStr, DBVisitType.W, this._collection);
                    break;
                default:
