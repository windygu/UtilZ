...
using UtilZ.Dotnet.WindowEx.Winform.Controls.PartAsynWait.Interface;

namespace UtilZ.Dotnet.WindowEx.Winform.Controls.PartAsynWait.Excute.Winform.V2
{
    /// <summary>
    /// Metro等待样式框
    /// </summary>
