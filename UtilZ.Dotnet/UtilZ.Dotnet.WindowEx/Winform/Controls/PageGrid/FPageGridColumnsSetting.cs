...
namespace UtilZ.Dotnet.WindowEx.Winform.Controls.PageGrid
{
    ...
    public partial class FPageGridColumnsSetting : NoneBorderForm
    {
        ...
        /// 当前绑定的全部列集合
        /// </summary>
        private readonly BindingListEx<ColumnSettingInfo> _columnSettingInfos = new BindingListEx<ColumnSettingInfo>();

        /// <summary>
        /// 隐藏列绑定列表
        /// </summary>
        private readonly BindingListEx<DataGridViewColumn> _hidenCols;
        ...
        public FPageGridColumnsSetting(Control parentControl, BindingListEx<DataGridViewColumn> hidenCols) : this()
        {
            this.TopLevel = false;
