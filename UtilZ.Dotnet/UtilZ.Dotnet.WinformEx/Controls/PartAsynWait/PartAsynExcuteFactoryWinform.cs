...
using System.Linq;
using System.Text;
using UtilZ.Dotnet.WinformEx.Controls.PartAsynWait.Excute;
using UtilZ.Dotnet.WinformEx.Controls.PartAsynWait.Excute.Winform;
using UtilZ.Dotnet.DeskBase.PartAsynWait.Interface;
using UtilZ.Dotnet.DeskBase.PartAsynWait.Excute;

namespace UtilZ.Dotnet.WinformEx.Controls.PartAsynWait
{
    /// <summary>
    /// Winform异步执行对象创建工厂类
    /// </summary>
    public class PartAsynExcuteFactoryWinform : PartAsynExcuteFactoryBase
    {
        ...
        public override IAsynExcute<T, TContainer, TResult> CreateExcute<T, TContainer, TResult>()
        {
            ...
            {
                asynExcute = new UtilZ.Dotnet.WinformEx.Controls.PartAsynWait.Excute.Winform.V1.WinformPartAsynExcuteV1<T, TContainer, TResult>();
            }
            else if (type == WinformPartAsynExcuteTypeDefine.OpacityDisableTab)
            {
                asynExcute = new UtilZ.Dotnet.WinformEx.Controls.PartAsynWait.Excute.Winform.V2.WinformPartAsynExcute2<T, TContainer, TResult>();
            }
            else if (type == WinformPartAsynExcuteTypeDefine.OpacityShadeDisableTab)
            {
                asynExcute = new UtilZ.Dotnet.WinformEx.Controls.PartAsynWait.Excute.Winform.V3.WinformPartAsynExcute3<T, TContainer, TResult>();
            }
            else if (type == WinformPartAsynExcuteTypeDefine.ScreenshotImgBackgrounDisableTab)
            {
                asynExcute = new UtilZ.Dotnet.WinformEx.Controls.PartAsynWait.Excute.Winform.V4.WinformPartAsynExcute4<T, TContainer, TResult>();
            }
            else if (type == WinformPartAsynExcuteTypeDefine.OpacityCustomerDisableTab)
            {
                asynExcute = new UtilZ.Dotnet.WinformEx.Controls.PartAsynWait.Excute.Winform.V5.WinformPartAsynExcute5<T, TContainer, TResult>();
            }
            else
            {
