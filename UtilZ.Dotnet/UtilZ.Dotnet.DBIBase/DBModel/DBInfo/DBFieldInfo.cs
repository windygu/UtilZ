...
namespace UtilZ.Dotnet.DBIBase.DBModel.DBInfo
{
    ...
    public class DBFieldInfo
    {
        ...
        /// </summary>
        [DisplayName("表")]
        public string OwerTableName { get; protected set; }

        /// <summary>
        /// 字段名
        /// </summary>
        [DisplayName("字段")]
        public string FiledName { get; protected set; }
        ...
        /// </summary>
        [DisplayName("数据库类型")]
        public string DbTypeName { get; protected set; }
        ...
        /// </summary>
        [DisplayName("字段类型")]
        public DBFieldType FieldType { get; protected set; }
        ...
        /// </summary>
        [DisplayName("主键")]
        public bool IsPriKey { get; protected set; }
