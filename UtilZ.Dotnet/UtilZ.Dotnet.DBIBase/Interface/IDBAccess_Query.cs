...
namespace UtilZ.Dotnet.DBIBase.Interface
{
    ...
    public partial interface IDBAccess
    {
        ...
        DBPageInfo QueryPageInfo(long pageSize, string sqlStr, Dictionary<string, object> sqlParameterDic = null);
        ...
        /// <param name="sqlParameterDic">命令的参数字典集合</param>
        /// <returns>分页信息</returns>
        DBPageInfo QueryPageInfo(IDbConnection con, long pageSize, string sqlStr, Dictionary<string, object> sqlParameterDic = null);
        ...
        string ConvertSqlToPagingQuerySql(string sqlStr, IEnumerable<DBOrderInfo> orderInfos,
        ...
        /// <param name="dataBaseVersion">数据库版本信息</param>
        /// <returns>数据表</returns>
        DataTable QueryPagingData(string sqlStr, string orderByColName, long pageSize, long pageIndex,
            bool orderFlag, Dictionary<string, object> sqlParameterDic = null, DataBaseVersionInfo dataBaseVersion = null);
        ...
        /// <param name="dataBaseVersion">数据库版本信息</param>
        /// <returns>数据表</returns>
        DataTable QueryPagingData(IDbConnection con, string sqlStr, string orderByColName, long pageSize,
