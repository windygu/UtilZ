...
namespace UtilZ.Dotnet.Ex.Base
{
    ...
    public class JavascriptEx
    {
        ...
        private static void Demo()
        {
            ...
            var ret00 = JavascriptEx.Eval("var obj = {};obj.name='jimmy';obj.sex='Male';");

            var ret0 = JavascriptEx.Eval("function f(){ var obj = {};obj.name='jimmy';obj.sex='Male';return obj};f();");

            var ret = JavascriptEx.Eval(@"12+23");
...
return {'lon':lon,'lat':lat}
            ...
            var ret2 = JavascriptEx.Eval(jsStr);
