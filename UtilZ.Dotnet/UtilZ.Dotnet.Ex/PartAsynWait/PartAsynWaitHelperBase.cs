...
using System.Linq;
using System.Text;
using UtilZ.Dotnet.Ex.PartAsynWait.Excute;
using UtilZ.Dotnet.Ex.PartAsynWait.Interface;
using UtilZ.Dotnet.Ex.PartAsynWait.Model;

namespace UtilZ.Dotnet.Ex.PartAsynWait
{
    /// <summary>
    /// 异步等待器基类
    /// </summary>
