...
namespace UtilZ.Lib.Base.Base
{
    ...
    public class PropertyMapObjectHelper
    {
            ...
            where W : class
        {
            ...
            PropertyMapObjectInfo mapObjectInfo = NSysMemoryCache.Get(key) as PropertyMapObjectInfo;
            if (mapObjectInfo == null)
            {
                ...
                NSysMemoryCache.Set(key, mapObjectInfo, _expiration);
            }
