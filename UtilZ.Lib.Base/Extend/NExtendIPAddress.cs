...
namespace UtilZ.Lib.Base.Extend
{
    ...
    /// IP类型扩展方法类
    /// </summary>
    public static class NExtendIPAddress
    {
        /// <summary>
        ...
        {
            return Regex.IsMatch(ipStr, NConstant.IPV4Reg);
        }
        ...
        {
            if (!NExtendIPAddress.ValidateIPV4(ipStr))
            {
        ...
        public static bool PortAvailable(this IPAddress ipaddr, int port)
        {
            ...
            var allports = NExtendIPAddress.GetUsedPorts(out tcpPorts, out udpPorts, out ipPorts);
        ...
        public static List<int> GetUsedPorts()
        {
            ...
            return NExtendIPAddress.GetUsedPorts(out tcpPorts, out udpPorts, out ipPorts);
        }
        ...
        public static IPAddress GetPingServerIpClientIp(string serverIp)
        {
            ...
            foreach (IPAddress ipAddr in ipaddrs)
            {
                ...
                if (NExtendIPAddress.ValidateClientIpPingServerIp(ipAddr.ToString(), serverIp))
                {
                    ipAddrRet = ipAddr;
                    break;
                }
        ...
        public static bool ValidateClientIpPingServerIp(string clientIp, string serverIp)
        {
            ...
            string pingResultStr = NExtendCmd.SynExcuteCmd(app, args);
