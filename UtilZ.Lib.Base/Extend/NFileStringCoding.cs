...
namespace UtilZ.Lib.Base.Extend
{
    ...
    /// 将文件编码成字符串与将字符串解码成文件
    /// </summary>
    public class NFileStringCoding
    {
        /// <summary>        
        ...
        {
            byte[] buffer = NFileStringCoding.DecodingString(strData);
        ...
        public static string EncodingFile(string filePath)
        {
            ...
            using (FileStream fs = new FileStream(filePath, FileMode.Open, FileAccess.Read))
            {
                ...
                return NFileStringCoding.EncodingBytes(buffer);
            }
        }
        ...
        public static string CompressEncoding(string input)
        {
            ...
            byte[] result = NExtendCompress.CompressBytes(inputBytes);
        ...
        public static string DecompressEncoding(string input)
        {
            ...
            byte[] depressBytes = NExtendCompress.DecompressBytes(inputBytes);
