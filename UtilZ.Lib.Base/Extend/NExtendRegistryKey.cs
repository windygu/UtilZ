...
namespace UtilZ.Lib.Base.Extend
{
    ...
    /// 注册表操作类
    /// </summary>
    public static class NExtendRegistryKey
    {
        /// <summary>
        /// 打开注册表
        /// </summary>
        ...
        public static RegistryKey OpenBaseKey(RegistryHive registryHive)
        {
        ...
        {
            RegistryKey localMachineRegistry = NExtendRegistryKey.OpenBaseKey(RegistryHive.LocalMachine);
            ...
            {
                NExtendRegistryKey.CloseRegistryKey(runRegKey);
            }
        }
        ...
        public static void SetAutoLogin(string userName, string password)
        {
            ...
            {
                NExtendRegistryKey.CloseRegistryKey(autoLogOnRegKey);
            }
        }
        ...
        public static void SetNotEventTrace(int value)
        {
            ...
            {
                NExtendRegistryKey.CloseRegistryKey(exEventRegKey);
            }
        }
