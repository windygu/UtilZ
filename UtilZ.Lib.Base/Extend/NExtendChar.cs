...
namespace UtilZ.Lib.Base.Extend
{
    ...
    ///  char类型扩展方法类
    /// </summary>
    public static class NExtendChar
    {
        /// <summary>
        /// 静态构造函数
        /// </summary>
        static NExtendChar()
        {
            ...
            {
                NExtendChar._chinesePunctuations.Add((int)chinesePunctuationStr[i]);
            }
        }
        ...
        public static bool IsChineseChar(this char ch)
        {
            ...
            //如果是中文字符返回true
            if (NExtendChar._chinesePunctuations.Contains(charValue))
            {
                return true;
            }

            //如果是中文汉字返回true
            if (charValue >= NExtendChar._chineseCharMinValue && charValue <= NExtendChar._chineseCharMaxValue)
            {
                return true;
            }
