...
namespace UtilZ.Lib.DBSqlite.Write
{
    ...
    public class SQLiteInsert<T> : SQLiteWriteBase where T : class
    {
        ...
        public SQLiteInsert(T item) : base(1)
        {
            this._item = item;
        }
        ...
        public SQLiteInsert(IEnumerable<T> items) : base(2)
        {
            this._items = items;
        }
        ...
        public override object Excute(ISQLiteDBAccessBase sqliteDBAccess, IDbConnection con)
        {
            ...
            {
                case 1:
                    this.Result = sqliteDBAccess.BaseInsertT<T>(this._item, con);
                    break;
                case 2:
                    this.Result = sqliteDBAccess.BaseBatchInsertT<T>(this._items, con);
                    break;
                default:
