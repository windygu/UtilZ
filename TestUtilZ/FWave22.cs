...
namespace TestUtilZ
{
    public partial class FWave22 : Form
    {
        public FWave22()
        {
            InitializeComponent();
        ...
        void wavePlayer1_WavLog(object sender, UtilZ.Lib.Wav.Model.WavLogInfoArgs e)
        {
        ...
        private void FWave22_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                var ret = UtilZ.Lib.Wav.ExBass.Bass.BASS_GetVolume();
                if (ret <= 0)
                {
