...
namespace UtilZ.Dotnet.DBOracle.Core
{
    ...
    public partial class OracleDBAccess : DBAccessBase
    {
        ...
        /// 数据库程序集名称
        /// </summary>
        private readonly string _databaseName = typeof(OracleConnection).Assembly.FullName;
        ...
        public OracleDBAccess(int dbid, IDBInteractiveBuilder interactiveBuilder) : base(dbid, interactiveBuilder)
        {
